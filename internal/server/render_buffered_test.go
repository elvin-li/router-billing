...
// TestRenderBuffersOnPartialFailure pins the v0.102 fix to render(): when
// ExecuteTemplate writes some bytes and *then* errors, the user must NOT
// see the partial output. Pre-v0.102 they got HTTP 200 + "<partial
...
// TestRenderMissingMapKeyIsZeroNotNoValue pins the v0.102 templating
// option missingkey=zero. Pre-v0.102 the default was "default", which
